                                            ...
                                            <div class="text-right">
                                                ...
                                                <div class="form-auth-row d-flex flex-wrap pt-3 pr-0">
                                                    <div class="col-md-4 col-sm-6 pr-0 mb-2">
                                                        <div class="form-account-title">
                                                            <input type="text" class="number-email-input" id="captcha"
                                                                   placeholder="حاصل کد امنیتی"
                                                                   name="captcha">
                                                            <small
                                                                class="text-danger font-weight-bold pr-2 captcha-error d-block"></small>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm">
                                                        ...
                                                        <button type="button" onclick="refreshCaptcha()"
                                                                class="btn btn-outline-info"><i class="fa fa-refresh"
                                                                                                aria-hidden="true"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row-account text-center">
                                                    <button class="btn btn-primary btn-login col-lg-4 col-md-6"
                                                            type="submit">ورود
                                                    </button>
                                                </div>
                                            </div>
