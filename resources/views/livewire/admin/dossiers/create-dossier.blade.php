                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <label>نام پرونده یا کیس <abbr class="required text-danger" title="ضروری">*</abbr></label>
                                    <div class="form-group">
                                        <input type="text" wire:model.defer="name" class="form-control @error('name') is-invalid @enderror" required />
                                        @error('name')
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" wire:model.defer="subject" id="subject" class="form-control @error('subject') is-invalid @enderror" required />
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" wire:model.defer="number_dossier" id="number_dossier" class="form-control @error('number_dossier') is-invalid @enderror" required />
                                ...
                                <div class="form-group col-md-3 col-sm-3 @error('dossier_type') is-invalid @enderror">
                                    ...
                                    <div wire:ignore>
                                        <select id="dossier-type" data-placeholder="انتخاب وضعیت" name="dossier_type" class="form-control ms select2">
                                ...
                                <div class="form-group col-md-3 col-sm-3 @error('user_category_id') is-invalid @enderror">
                                    ...
                                    <div wire:ignore>
                                        <select id="userSelect" name="user_category_id" data-placeholder="انتخاب رده" class="form-control ms search-select">
                                            <option></option>
                                ...
                                <div class="form-group col-md-3 col-sm-3 @error('laboratory_id') is-invalid @enderror">
                                    <label for="userSelect">آزمایشگاه <abbr class="required text-danger" title="ضروری">*</abbr></label>
                                    <div wire:ignore>
                                        <select id="laboratorySelect" name="laboratory_id" data-placeholder="انتخاب آزمایشگاه" class="form-control ms search-select">
                                            <option></option>
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-md-12 @error('summary_description') is-invalid @enderror">
                                    <label for="summernote">خلاصه پرونده <abbr class="required text-danger" title="ضروری">*</abbr></label>
                                    <div wire:ignore>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="dossier_case" id="dossier_case" class="form-control @error('dossier_case') is-invalid @enderror" required />
                                    ...
                                    <div class="form-group col-md-4">
                                        <label> شماره همراه کارشناس پرونده <abbr class="required text-danger" title="ضروری">*</abbr>
                                        </label>
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="expert_phone" id="expert_phone" class="form-control @error('expert_phone') is-invalid @enderror" required />
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>شماره داخلی کارشناس پرونده<abbr class="required text-danger" title="ضروری">*</abbr>
                                        </label>
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="expert_cellphone" id="expert_cellphone" class="form-control @error('expert_cellphone') is-invalid @enderror" required />
                                    ...
                                    <div class="form-group col-md-12 @error('expert') is-invalid @enderror">
                                        <label>درخواست کارشناس پرونده از آزمایشگاه <abbr class="required text-danger" title="ضروری">*</abbr></label>
                                        <div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" wire:model.defer="Judicial_number" id="delivery-name" class="form-control @error('Judicial_number') is-invalid @enderror" />
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group" wire:ignore>
                                                ...
                                                <input type="text" class="form-control" id="JudicialDate" value="{{ $Judicial_date ?? null }}" autocomplete="off">
                            ...
                            <div class="col-12">
                                <button wire:click="create(1)" wire:loading.attr="disabled" class="btn btn-raised btn-success waves-effect"><i wire:loading class='zmdi zmdi-hc-fw zmdi-hc-spin'></i>
                                    ذخیره
                                </button>
                                <button wire:click="create(2)" wire:loading.attr="disabled" class="btn btn-raised btn-success waves-effect"><i wire:loading class='zmdi zmdi-hc-fw zmdi-hc-spin'></i>
