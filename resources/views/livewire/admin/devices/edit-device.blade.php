                            ...
                            <form wire:submit.prevent="edit">
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-sm-6 col-sm-6 @error('category_id') is-invalid @enderror">
                                        <label for="title-device">انتخاب شواهد دیجیتال <abbr class="required" title="ضروری" style="color:red;">*</abbr></label>
                                        <div wire:ignore>
                                            <select id="title-device" name="title_managements_id" data-placeholder="انتخاب دسته بندی" required class="form-control ms search-select">
                                                <option></option>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group" wire:ignore>
                                            ...
                                            <input type="text" class="form-control" id="createDate" dir="ltr" value="{{ $receive_date ?? null }}" autocomplete="off">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon1" style="cursor: pointer;" onclick="destroyDatePicker2()"><i class="zmdi zmdi-close"></i></span>
                                            </div>
                                        </div>
                                        @error('receive_date')
                                        <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="form-group col-md-3 col-sm-3 @error('parent_id') is-invalid @enderror">
                                        <label for="rel"> ارتباط با سایر شواهد<abbr class="required" title="ضروری" style="color:red;">*</abbr></label>
                                        <div wire:ignore>
                                            <select id="rel" name="parent_id" data-placeholder="انتخاب پرونده" class="form-control ms search-select">
                                                <option value=0 @selected($device->parent_id == 0)>شاهد اصلی </option>
                                                @foreach ($parent_devices as $parent_device)
                                                <option value="{{ $parent_device->id }}" @selected($device->parent_id == $parent_device->id)  @disabled($device->id==$parent_device->id) >
                                    ...
                                    <div class="form-group col-md-3 col-sm-3 @error('status') is-invalid @enderror">
                                        ...
                                        <div wire:ignore>
                                            <select id="statusSelect" data-placeholder="انتخاب وضعیت" class="form-control ms select2 statusSelect">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="receiver_name" id="receiver-name" class="form-control @error('receiver_name') is-invalid @enderror" />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="receiver_code" id="receiver_code" class="form-control @error('receiver_code') is-invalid @enderror" />
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-md-4 col-sm-4 @error('dossier_id') is-invalid @enderror">
                                        ...
                                        <div wire:ignore>
                                            <select id="userSelect" name="dossier_id" data-placeholder="انتخاب پرونده" class="form-control ms search-select">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="delivery_name" id="delivery-name" class="form-control @error('delivery_name') is-invalid @enderror" required />
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="delivery_code" id="delivery_code" class="form-control @error('delivery_code') is-invalid @enderror" />
                                ...
                                <div class="header">
                                    ...
                                    <button wire:click="printReport()" type="button" wire:loading.attr="disabled" style="float: left" class="btn btn-raised btn-warning waves-effect"><i wire:loading class='zmdi zmdi-hc-fw zmdi-hc-spin'></i>
                                        پرینت گزارش نهایی
                                    </button>
                                </div>
                                <hr>
                                ...
                                <div class="body">
                                    ...
                                    <div class="form-group" wire:ignore>
                                        <input type="file" class="dropify" name="attachment_report" id="attachment_report" wire:model="attachment_report" data-max-file-size="40M" value={{ $device->attachment_report ? url(env('ATTACHMENT_REPORT_UPLOAD_PATCH') . $device->attachment_report) : null}} data-default-file={{ $device->attachment_report ? url(env('ATTACHMENT_REPORT_UPLOAD_PATCH') . $device->attachment_report) : null}} data-allowed-file-extensions="docx xlsx pdf csv zip rar">
                                    </div>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="correspondence_number" id="correspondence_number" class="form-control @error('correspondence_number') is-invalid @enderror" />
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group" wire:ignore>
                                            ...
                                            <input type="text" class="form-control" id="correspondenceDate" dir="ltr" value="{{ $correspondence_date ?? null }}" autocomplete="off">
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group">
                                            <input type="text" wire:model.defer="reply_correspondence_number" id="reply_correspondence_number" class="form-control @error('reply_correspondence_number') is-invalid @enderror" />
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group" wire:ignore>
                                            <div class="input-group-prepend" onclick="$('#reply_correspondenceDate').focus();">
                                                <span class="input-group-text" id="basic-addon1"><i class="zmdi zmdi-calendar-alt"></i></span>
                                            </div>
                                            <input type="hidden" id="reply_correspondenceDate-alt" name="reply_correspondence_date">
                                            <input type="text" class="form-control" id="reply_correspondenceDate" dir="ltr" value="{{ $reply_correspondence_date ?? null }}" autocomplete="off">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon1" style="cursor: pointer;" onclick="destroyDatePicker3()"><i class="zmdi zmdi-close"></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" wire:loading.attr="disabled" class="btn btn-raised btn-success waves-effect"><i wire:loading wire:loading wire:target="attachment_report" class='zmdi zmdi-hc-fw zmdi-hc-spin'></i>
                                        ذخیره
                                    </button>
                                </div>
                            </form>
