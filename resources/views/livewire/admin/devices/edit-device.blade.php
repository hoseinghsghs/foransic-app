                    ...
                    <div class="card">
                        <div class="body">
                            <form wire:submit.prevent="edit">
                                ...
                                <hr>
                                <div class="row clearfix">
                                    <div class="form-group col-sm-6  @error('category_id') is-invalid @enderror">
                                    ...
                                    @endif
                                    {{-- تحویل گیرنده --}}
                                    <div @class(['d-none','d-inline'=>$status =='3'])>
                                        <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-md-3 col-sm-3 @error('parent_id') is-invalid @enderror">
                                            <label for="rel"> ارتباط با سایر شواهد<abbr class="required" title="ضروری"
                                                    style="color:red;">*</abbr></label>
                                            <div>
                                                <select id="rel" name="parent_id" data-placeholder="انتخاب پرونده" wire:model.defer="parent_id"
                                                    class="form-control ms search-select">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-6 col-12 @error('accessories') is-invalid @enderror">
