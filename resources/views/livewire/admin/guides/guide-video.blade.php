                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="custom-file d-flex flex-row-reverse">
                            <input wire:model="vid" type="file" class="custom-file-input" id="customFile" lang="ar" dir="rtl">
                                    ...
                                    <div class="card">
                                        <a class="file" target="_blank">
                                            <div class="hover">
                                                ...
                                                <button wire:click="edit_video({{ $guide->id }})" wire:loading.attr="disabled" {{ $display }} class="btn btn-icon btn-warning btn-icon-mini btn-round scroll">
                                                    <i class="zmdi zmdi-edit"></i>
                                                    <span class="spinner-border spinner-border-sm text-light" wire:loading wire:target="edit_video({{ $guide->id }}) "></span>
                                                </button>
                                            ...
                                            <video width="100%" controls>
                                                <source src="{{ url(env('GUIDE_VIDEO_PATCH') . $guide->url) }}" type="video/mp4">
                                            </video>
                                        </a>
                                        <div class="mt-2">
                                            {{$guide->category}}
