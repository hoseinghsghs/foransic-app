                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <input type="text" name="program_version" wire:model.defer="program_version" class="form-control">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <label>کد سخت افزاری <abbr class="required" title="ضروری" style="color:red;">*</abbr></label>
                                    <input type="text" name="hardware_code" wire:model.defer="hardware_code" class="form-control">
                                    @error('hardware_code')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>

                                <div class="form-group col-md-6 @error('description_personal') is-invalid @enderror mt-3">
                                    <label> توضیحات پرسنل درخواست کننده <abbr class="required" title="ضروری" style="color:red;">*</abbr></label>
                                    <textarea class="form-control" rows="9" wire:model.defer="description_personal">{!! $description_personal !!}</textarea>
                                ...
                                <div class="col-md-6 col-sm-6 mt-3">
                                    ...
                                    <div class="form-group" wire:ignore>
                                        <input type="file" class="dropify" name="license_file" id="license_file" wire:model="license_file" data-max-file-size="40M" data-allowed-file-extensions="docx xlsx pdf csv zip rar">
                                    </div>
                                    <div class="progress" role="progressbar" aria-label="Animated striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                        <div wire:loading wire:target="license_file" class="progress-bar progress-bar-striped progress-bar-animated" style="width: 100%"></div>
                                    </div>
                                    @if ($is_edit)
                                    @if($crack)
                                    لینک دانلود :
                                ...
                                <div class="form-group col-md-12 @error('description_admin') is-invalid @enderror mt-3">
                                    <label> توضیحات مدیریت <abbr class="required" title="ضروری" style="color:red;">*</abbr></label>
                                    <div>
                                        <textarea class="form-control" rows="4" wire:model.defer="description_admin">{!! $description_admin !!}</textarea>
                                    </div>
                                ...
                                <div class="form-group col-md-6 mt-3">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <textarea class="form-control" rows="9" disabled>{!! $description_admin !!}</textarea>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class=" col-12">
                                    ...
                                    @if (!auth()->user()->hasRole('Super Admin') && !$crack->license_file)
                                    <button wire:click="add_crack" wire:loading.attr="disabled" class="btn btn-raised btn-warning waves-effect">
                                        ویرایش
                                        <span class="spinner-border spinner-border-sm text-light" wire:loading wire:target="add_crack"></span>
                                    </button>
                                    @endif
                                    @else
                                    <button wire:click="add_crack" wire:loading.attr="disabled" class="btn btn-raised {{ $is_edit ? 'btn-warning' : 'btn-primary' }}  waves-effect">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="{{ $crack->id }}" wire:loading.attr="disabled">
                                            ...
                                            <td class="text-center js-sweetalert">
                                                <button wire:click="edit_crack({{ $crack->id }})" wire:loading.attr="disabled" {{ $display }} class="btn btn-raised btn-info waves-effect scroll">
                                                    <i class="zmdi zmdi-edit"></i>
                                                    <span class="spinner-border spinner-border-sm text-light" wire:loading wire:target="edit_crack({{ $crack->id }}) "></span>
                                                </button>
