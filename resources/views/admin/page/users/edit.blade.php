                                            ...
                                            <div class="form-group">
                                                <select id="positionSelect" name="role" data-placeholder="انتخاب نقش"
                                                    ...
                                                    @forelse ($roles as $role)
                                                        <option
                                                            value="{{$role->name}}" @selected(in_array($role->id,$user->roles->pluck('id')->toArray()))>{{$role->display_name}}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                                @error('role')
                                                ...
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading" role="tab" id="headingOne_1">
                                                        <h4 class="panel-title"><a role="button" data-toggle="collapse"
                                                                                   ...
                                                                                   href="#collapseOne_1"
                                                                                   aria-expanded="true"
                                                                                   aria-controls="collapseOne_1">مجوز ها<span
                                                                    class="float-left">&#10095</span></a></h4>
                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <div class="checkbox">
                                                                            <input id="checkbox-{{$index}}"
                                                                                   ...
                                                                                   value="{{$permission->name}}" @checked(in_array($permission->id,$user->permissions->pluck('id')->toArray()))>
                                                                            <label
