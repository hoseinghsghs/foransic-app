                        ...
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" class="needs-validation"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="positionSelect" name="type" data-placeholder="انتخاب محل"
                                                ...
                                                <option {{ $banner->type == 'بالای منو' ? 'selected' : '' }}>بالای منو
                                                </option>
                                                ...
                                                <option {{ $banner->type == 'عرضی' ? 'selected' : '' }} disabled>عرضی
                                                </option>
                                                <option {{ $banner->type == 'آخر-راست' ? 'selected' : '' }} disabled>
                                                    آخر-راست
                                                </option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="color" id="text_color"
                                                    class="form-control" value="{{ old('color') ?? $banner->color }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input name="image" id="image" type="file"
                                                    ...
                                                    data-allowed-file-extensions="jpg png jpeg svg gif wbm"
                                    ...
                                    <div class="form-group">
                                        <button type="submit"
                                            class="btn btn-raised btn-primary waves-effect">ذخیره</button>
                                    </div>
                                </form>
                            </div>
                        </div>
