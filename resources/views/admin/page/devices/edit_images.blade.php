...
@section('Content')
    ...
    <section class="content">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href={{ route('admin.home') }}><i class="zmdi zmdi-home"></i>
                                    خانه</a></li>
                            <li class="breadcrumb-item"><a href={{ route('admin.devices.index') }}>لیست شواهد دیجیتال </a>
                            </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 ">
                                <form action="{{ route('admin.device.images.add', ['device' => $device->id]) }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="header">
                                        <label for="primary_image">تصویر مکاتبه</label>
                                    </div>
                                    <div class="body">
        ...
        @endpush
        @php
            $device_images = $device->images->all();
        @endphp
        @push('scripts')
            <!-- dropzone script start -->
            <script>
                let variations = @json($device_images);
                    ...
                    init: function() {
                        variations.forEach(variation => {
                            ...
                            thisDropzone.emit("thumbnail", mockFile,
                                "{{ env('APP_URL') }}" + '/storage/other_device_image/' + variation.image)
                        }, )
                        dzClosure =
