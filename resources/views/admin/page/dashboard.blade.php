                            ...
                            <div class="body">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="89" aria-valuemin="0"
                                         ...
                                         style="width: {{ ($status_device_4 / ($all_devices > 0 ? $all_devices : 1)) * 100 }}%;background : rgb(181, 136, 255)">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-hover c_table">
                                        ...
                                        @foreach ($status_device_checks as $status_device_check)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="list-name">{{ $status_device_check->category->title }}</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn bg-teal waves-effect"
                                                            data-toggle="modal" data-target="#defaultModal-{{ $key }}">
                                                        <i class="zmdi zmdi-eye"></i></button>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="defaultModal-{{ $key }}" tabindex="-1"
                                                 role="dialog">
                            ...
                            <div class="body bg-green">
                                <a href="{{ route('admin.dossiers.create') }}">
                                    <div class="icon col-12 m-t-10">
                                        <div class="chart chart-bar"><i class="zmdi zmdi-plus-circle-o"
                                                                        style="font-size: 4.2rem; padding: 0.76rem;"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="body bg-red">
                                <a href="{{ route('admin.dossiers.index') }}">
                                    <div class="icon col-12">
                                        <div class="chart chart-pie"><i class="zmdi zmdi-file"
                                                                        style="font-size: 4.2rem; padding: 1rem;"></i>
                                        </div>
                                    </div>
                                    <div class="content col-12">
                            ...
                            <div class="body bg-blue">
                                <a href="{{ route('admin.devices.index') }}">
                                    <div class="icon col-12 m-t-5">
                                        <span class="chart chart-line"><i class="zmdi zmdi-devices"
                                                                          style="font-size: 4.2rem; padding: 0.9rem;"></i></span>
                                    </div>
                                    <div class="content col-12">
                        ...
                        <div class="body">
                            <div class="card">
                                <div class="header mb-2">
                                    <h2 style="font-size: 1.1rem;"><strong><i class="zmdi zmdi-image"
                                                                              style="font-size:1.6rem;"></i> </strong>
                                        بنر امروز
                                    </h2>
                                </div>
                                @if($image)
                                    <div class="blogitem-image">
                                        <img src="{{ url(env('GUIDE_IMAGES_PATCH') . $image->url) }}" alt=""
                                             width="100%" style="border-radius: 0.6rem;">
                                        @endif
                                    </div>
                            </div>
                        </div>
