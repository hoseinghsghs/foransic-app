...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="navbar-brand">
        ...
        <a href="{{ route('admin.home') }}"><img src="{{ $setting->logo ? asset('storage/logo/' . $setting->logo) : '/images/logo.png' }}" style="margin-right:50px;max-height: 3rem;" height="37px" alt="meta-webs"><span class="m-l-10"></span></a>
    </div>
    <div class="menu">
        <ul class="list" id="myList">
            <li>
                <div class="user-info flex-wrap">
                    ...
                    <div class="w-100 d-flex justify-content-around d-md-none">
                        @hasanyrole($roles)
                        <span class="dropdown">
                            <a href="javascript:void(0);" class="dropdown-toggle p-1" title="Notifications" data-toggle="dropdown" role="button"><i class="zmdi zmdi-notifications text-black"></i>
                        ...
                        @endhasanyrole
                        <span><a href="javascript:void(0);" class="js-right-sidebar p-1" title="Setting"><i class="zmdi zmdi-settings zmdi-hc-spin text-black"></i></a></span>
                        <span><a href="#" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();" class="p-1" title="Sign Out"><i class="zmdi zmdi-power"></i></a>
            ...
            <li @class([ 'active open'=> request()->routeIs('admin.laboratory'),
                ])>
            ...
            <li @class([ 'active open'=> request()->routeIs(
                ...
                <ul class="ml-menu">
                    ...
                    @endcan
                    @can('dossiers-section-list')
                    <li @class(['active'=> request()->routeIs('admin.dossiers.section')])><a href={{ route('admin.dossiers.section') }}>اضافه کردن معاونت</a>
                    </li>
                    @endcan
                    @can('dossiers-zone-list')
                    <li @class(['active'=> request()->routeIs('admin.dossiers.zone')])><a href={{ route('admin.dossiers.zone') }}>اضافه کردن حوزه اقدام</a>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li @class([ 'active open'=> request()->routeIs(
                ...
                <ul class="ml-menu">
                    ...
                    <li @class(['active'=> request()->routeIs(['admin.devices.index','admin.devices.edit','admin.devices.show'])])>
                        <a href={{ route('admin.devices.index') }}>لیست شواهد دیجیتال</a>
                    </li>
                    @endcan
                    @can(['devices-archive-list'])
                    <li @class(['active'=> request()->routeIs('admin.devices.archive')])><a href={{ route('admin.devices.archive') }}>لیست شواهد دیجیتال بایگانی
                        </a>
                    </li>
                    @endcan
                    @canany(['categories-list'])
                    <li @class(['active'=> request()->routeIs('admin.devices.category')])><a href={{ route('admin.devices.category') }}>دسته بندی شواهد دیجیتال
                            ها</a>
                    </li>
                    @endcanany
                    @canany(['attributes-list'])
                    <li @class(['active'=> request()->routeIs('admin.devices.attribute')])><a href={{ route('admin.devices.attribute') }}>ویژگی های دسته بندی</a>
                    </li>
                    @endcanany
            ...
            <li @class([ 'active open'=> request()->routeIs(
                ...
                <ul class="ml-menu">
                    <li @class(['active'=> request()->routeIs('admin.tools.qr')])><a href={{ route('admin.tools.qr') }}>
                            تولید QR کد</a></li>
                            <li @class(['active'=> request()->routeIs('admin.tools.convert')])><a href={{ route('admin.tools.convert') }}>
                             تبدیل واحد ها </a></li>
                </ul>
            ...
            <li @class([ 'active open'=> request()->routeIs(
                ...
                'admin.permissions',
                'admin.roles.*'),
                ])><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-hc-fw"></i><span>کاربران</span></a>
                <ul class="ml-menu">
                    @can('users-create')
            ...
            <li @class([ 'active open'=> request()->routeIs(
                ...
                'admin.guides.videos',
                'admin.guides.files'),
                ])><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-help"></i><span>آموزش</span></a>
                <ul class="ml-menu">
