        ...
        <ul class="list" id="myList">
            ...
            @hasanyrole($roles)
                ...
                @canany(['dossiers-list', 'dossiers-create', 'dossiers-edit', 'dossiers-delete', 'dossiers-archive-list',
                    'dossiers-export', 'dossiers-section-list', 'dossiers-zone-list'])
                    <li @class([
                        ...
                        <ul class="ml-menu">
                            ...
                            @can('dossiers-section-list')
                                <li @class(['active' => request()->routeIs('admin.dossiers.section')])><a href={{ route('admin.dossiers.section') }}>اضافه نمودن
                                        معاونت</a>
                                </li>
                            @endcan
                            @can('dossiers-zone-list')
                                <li @class(['active' => request()->routeIs('admin.dossiers.zone')])><a href={{ route('admin.dossiers.zone') }}>اضافه نمودن حوزه
                                        اقدام</a>
                                </li>
                            @endcan
                        </ul>
                ...
                @canany(['devices-list', 'devices-archive-list', 'devices-create', 'categories-list', 'attributes-list',
                    ...
                    <li @class([
                        'active open' => request()->routeIs('admin.devices.*', 'admin.actions.*'),
                    ])>
                        ...
                        <ul class="ml-menu">
                            ...
                            @can(['devices-archive-list'])
                                <li @class(['active' => request()->routeIs('admin.devices.archive')])><a href={{ route('admin.devices.archive') }}>لیست شواهد دیجیتال
                                        بایگانی
                                    </a>
                                </li>
                            @endcan
                            @canany(['categories-list'])
                                <li @class(['active' => request()->routeIs('admin.devices.category')])><a href={{ route('admin.devices.category') }}>دسته بندی شواهد
                                        دیجیتال
                                        ها</a>
                                </li>
                            @endcanany
                            @canany(['attributes-list'])
                                <li @class(['active' => request()->routeIs('admin.devices.attribute')])><a href={{ route('admin.devices.attribute') }}>ویژگی های دسته
                                        بندی</a>
                                </li>
                            @endcanany
                            @can(['actions-category-list'])
                                <li @class(['active' => request()->routeIs('admin.actions.category')])><a href={{ route('admin.actions.category') }}> اضافه نمودن عنوان
                                        اقدام
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['cracks-list', 'cracks-create', 'cracks-edit', 'cracks-delete', 'cracks-archive-list'])
                    <li @class([
                        ...
                        <ul class="ml-menu">
                            @can('cracks-create')
                                <li @class(['active' => request()->routeIs('admin.cracks.create')])><a href={{ route('admin.cracks.create') }}>ثبت درخواست لایسنس</a>
                                </li>
                            @endcan
                ...
                <li @class(['active open' => request()->routeIs('admin.tools.*')])>
