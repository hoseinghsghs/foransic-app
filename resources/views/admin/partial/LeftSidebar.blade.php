            ...
            <li>
                <div class="user-info flex-wrap">
                    ...
                    <div class="detail">
                        ...
                        @hasanyrole($roles)<small>{{ auth()->user()->roles->first()->name }}</small>@endhasanyrole
                    </div>
                    ...
                    <ul class="ml-menu">
                        @can('products')
                            <li @class(['active' => request()->routeIs('admin.devices.index')])><a
                                    href={{ route('admin.devices.index') }}>لیست دیوایس</a></li>

                            <li @class(['active' => request()->routeIs('admin.archive')])><a
                                    href={{ route('admin.archive') }}>لیست دیوایس بایگانی شده</a>
                            </li>

                            <li @class(['active' => request()->routeIs('admin.devices.create')])><a
                                    href={{ route('admin.devices.create') }}>ایجاد دیوایس</a></li>
                        @endcan
